...
const sequence = [
    { func: playEn, delay: 0 },        // Start immediately
    { func: playRu, delay: 4000 },      // Wait 2s after previous
    { func: playEn, delay: 4000 },
    { func: playEn, delay: 4000 },
    { func: playExEn, delay: 4000 },     // Wait 2s after previous
    { func: playExEn, delay: 4000 },     // Wait 2s after previous
    { func: playExRu, delay: 4000 },      // Wait 2s after previous
    { func: playExEn, delay: 4000 },     // Wait 2s after previous
    { func: playExEn, delay: 4000 },     // Wait 2s after previous
];
...
(function() {
    ...
    console.log('TikTok remote: UP=PlayAll, UP×2=NextWord');
})();
